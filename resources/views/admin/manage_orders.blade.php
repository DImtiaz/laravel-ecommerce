						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center"> <span class=" "> {{$v_order->order_status}}</span></td>

								<td class="center d-inline">
									@if($v_order->order_status=='pending')
									<a class="btn f11 btn-success" href="{{URL::to('/approve_order/'.$v_order->order_id)}}">
									...
									<a class="btn f11 btn-danger" href="{{URL::to('/cancel_order/'.$v_order->order_id)}}" id="">
