...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{URL::to('/dashboard')}}"><span>Ecommerce</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categry</span></a></li>
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-edit"></i><span class="hidden-tablet"> Slider</span><span class="label label-important"></span></a>
							<ul>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; <?php echo date('Y'); ?> Dewan Imtiaz Been Emran</span>
	...
	<!-- start: JavaScript-->
		...
		<script src="{{asset('back/js/bootbox.js')}}"></script>
		<script>
			$(document).on("click","#delete", function(e){
				e.preventDefault();
				let link = $(this).attr("href");
				bootbox.confirm("Do you want to Delete selected category?" , function(confirmed){
					if (confirmed){
