...
<h2 class="title text-center">{{$v_product_by_manufacture->manufacture_name}} Items</h2>
<div class="col-sm-4">
    <div class="product-image-wrapper">
        <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{URL::to($v_product_by_manufacture->product_image)}}" alt="" style="height: 249px;" />
